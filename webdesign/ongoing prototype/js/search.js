$(document).ready(function(){
    $("#filter").keyup(function(){
       ...
       // alert( "Handler for .keyup() called." );
        ...
        $("h2, h3, h4, p, div, span, ol, li, section, #social, #book-downloads").not("#reference-list, .pushmenu pushmenu-left, #filter-count").each(function(){            
               // console.log($(this));
      ...
      if (0 < filter.length) {
        var elem = $('<div id="search_ui" style="position: fixed; right: 10px; top: 10px;"><button>Cancel</button></div>');
        $('body').append(elem);
        $(elem).children('button').on('click', function (e) {
            // add more code here
        ...
        $('#search_ui, #filter-count, .text').remove();
      }
